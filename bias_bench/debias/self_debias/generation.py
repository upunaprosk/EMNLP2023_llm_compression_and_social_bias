...
class SelfDebiasingLLamaLMHeadModel(LlamaForCausalLM, GenerationMixin):
    """
    This class represents a regular LlamaForCausalLM that additionally has the capacity to perform self-debiasing. For self-debiasing, the
...
class SelfDebiasingOPTLMHeadModel(OPTForCausalLM, GenerationMixin):
    """
    This class represents a regular LlamaForCausalLM that additionally has the capacity to perform self-debiasing. For self-debiasing, the
    init_logits_processor function must be called. Otherwise, this model just performs regular language modeling.
    """
